...
| *Freemium* | 24 VMs de armazenamento total 1,2 


| * Capacidade baseada em PAYGO ou BYOL* 3 | 24 VMs de armazenamento total 1,2 
...
| * Baseado em nós BYOL* 4 | 24 VMs de armazenamento total 1,2 
|===
